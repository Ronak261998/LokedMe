...
public class Project {
	...
	public static void main(String[] args) {
		...
		File directory = new File("C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1");
		...
		System.out.println("*****************************************");
		System.out.println("******* Ronak Gupta  *********************");
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1" + filename + ".txt ");
			...
			case 3:
				...
				File directory_delete = new File("C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C:\\Users\\Ronak Gupta\\eclipse-workspace\\Java Phase 1\\src\\Project_phase1");
